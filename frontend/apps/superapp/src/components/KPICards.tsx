  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
      ...
      <KPICard
        ...
        label="Total Volume"
        value={kpis.volume.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
        accentColor="#22C55E"
      />
      <KPICard
        icon={<TrendingUp size={22} style={{ color: '#F59E0B' }} />}
        label="Average Amount"
        value={kpis.avg.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
        accentColor="#F59E0B"
      />
      <KPICard
